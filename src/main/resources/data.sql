...
insert into role (role_name,role_code,user_id) values('Customer','Customer',2);
insert into role (role_name,role_code,user_id) values('Branch Manager','Branch Manager',1);
insert into role (role_name,role_code,user_id) values('Customer','Customer',4);
insert into role (role_name,role_code,user_id) values('Customer','Customer',3);
